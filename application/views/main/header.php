...
?> menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children  menu-item-2075"><a href="<?php echo base_url("about");?>">ABOUT</a>

			</li>
	<li id="menu-item-1897" class="<?php if (isset($menu) && $menu == 'officetel') {
	echo 'active-menu';
}
?> menu-item menu-item-type-post_type menu-item-object-page menu-item-1897"><a href="<?php echo base_url("officetel");?>">OFFICE TEL</a></li>
	<li id="menu-item-2075" class="<?php if (isset($menu) && $menu == 'apartment') {
	echo 'active-menu';
}
?> menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children  menu-item-2075"><a href="<?php echo base_url("apartment");?>">APARTMENT</a>
...
?> register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="<?php echo base_url('house');?>">HOUSE</a></li>

<li  id="register-modal" class="<?php if (isset($menu) && $menu == 'villas') {
	echo 'active-menu';
}
?> register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="<?php echo base_url('villas');?>">VILLAS</a></li>
<li  id="register-modal" class="<?php if (isset($menu) && $menu == 'serviced_apartment') {
	echo 'active-menu';
}
?> register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="<?php echo base_url('serviced_apartment');?>">SERVICED APARTMENT</a></li>
<li  id="register-modal" class="<?php if (isset($menu) && $menu == 'contact') {
	echo 'active-menu';
}
?> register menu-item menu-item-type-post_type menu-item-object-page menu-item-1945"><a href="<?php echo base_url('contact');?>">CONTACT</a></li>
