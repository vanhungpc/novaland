            ...
            <div class="widget_inside">
                <div class="col_12">
                    <div class="pre_2 col_8 last">
                        <div class="form">
                            <form id="form0" action="<?php echo site_url('aboutus/editAboutUsFormSubmission/' . $aboutus['_id_aboutus']) ?>"  method="post"  enctype="multipart/form-data">
                                 ...
                                 <div class="clearfix">
                                    ...
                                    <textarea id="txt_content" name="txt_content"><?php echo $aboutus['content_aboutus'] ?></textarea>
                                    </span> </div>
                                <div class="clearfix">
                                    <div class="input" style="margin-left:300px !important;">
                                        <input type="submit" class="button blue" value="Update about us" />
                                    </div>
                                </div>
                            </form>
                        </div>
