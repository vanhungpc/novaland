            ...
            <div class="widget_inside">
                <div class="col_12">
                    <div class="pre_2 col_8 last">
                        <div class="form">
                            <form id="form0" action="<?php echo site_url('news/editNewsFormSubmission/' . $news['_id_news'])?>"  method="post"  enctype="multipart/form-data">
                                <div class="clearfix">
                                    <label>Title</label>
                                    <div class="input">
                                        <input class="xlarge validate[required]" type="text" name="title" id="title" value="<?php echo $news['title']?>" />
                                    </div>
                                </div>
                                 ...
                                 <div class="clearfix">
                                    ...
                                    <textarea id="txt_content" name="txt_content"><?php echo $news['content']?></textarea>
                                    </span> </div>
                                <div class="clearfix">
                                    <div class="input" style="margin-left:300px !important;">
                                        <input type="submit" class="button blue" value="Update news" />
                                    </div>
                                </div>
                            </form>
                        </div>
