...
?>>
            <a href="<?php echo site_url() . 'year';?>"><span>Year</span></a>
        </li>
           <li <?php
if ($controller == 'enginesize') {
	echo 'class="active iconed"';
}
?>>
            <a href="<?php echo site_url() . 'enginesize';?>"><span>Engine Size</span></a>
        </li>
        <li <?php
if ($controller == 'types') {
	echo 'class="active iconed"';
...
?>>
            <a href="<?php echo site_url() . 'types';?>"><span>Types</span></a>
        </li>
...
?>>
            <a href="<?php echo site_url() . 'coupons';?>"><span>Coupons</span></a>
        </li>
        <li <?php
if ($controller == 'users') {
	echo 'class="active iconed"';
...
?>>
            <a href="<?php echo site_url() . 'users';?>"><span>Users</span></a>
        </li>
        <li <?php
...
?>>
            <a href="<?php echo site_url() . 'company';?>"><span>Change company</span></a>
        </li>
        <li <?php
...
?>>
            <a href="<?php echo site_url() . 'slider';?>"><span>Slider</span></a>
        </li>

        <li <?php
if ($controller == 'purchasedproduct') {
	echo 'class="active iconed"';
}
?>>
            <a href="<?php echo site_url() . 'purchasedproduct';?>"><span>Purchased Product</span></a>
        </li>
        <li <?php
...
?>>
            <a href="<?php echo site_url() . 'background';?>"><span>Background</span></a>
        </li>
