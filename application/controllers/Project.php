...
class Project extends CI_Controller {
	...
	public function index() {
		...
		$data['project'] = $this->project->project($this->session->userdata('id'));
	...
	public function addProjectFormSubmission() {
...
//            $delete = $this->vehicleModel->deleteTemp();
	...
	public function editProjectFormSubmission($_id_project) {
...
//            $delete = $this->vehicleModel->deleteTemp();
	...
	public function viewProject($_id_project) {
